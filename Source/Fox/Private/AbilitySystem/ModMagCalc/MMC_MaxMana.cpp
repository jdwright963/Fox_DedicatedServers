...
{
	// GetIntelligenceAttribute is a static function in FoxAttributeSet that is created by the ATTRIBUTE_ACCESSORS macro
	IntDef.AttributeToCapture = UFoxAttributeSet::GetIntelligenceAttribute();
